...
#ifndef	_Release_ResponsePDU_H_
#define	_Release_ResponsePDU_H_
...
/* Release-ResponsePDU */
typedef struct Release_ResponsePDU {
	OCTET_STRING_t	 associationId;
	ServiceError_t	 serviceError;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} Release_ResponsePDU_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_Release_ResponsePDU;

#ifdef __cplusplus
}
#endif

#endif	/* _Release_ResponsePDU_H_ */
