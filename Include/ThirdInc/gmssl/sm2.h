...
int sm2_private_key_info_from_pem(SM2_KEY *key, uint8_t **attrs, size_t *attrslen, FILE *fp);
...
int sm2_sign_ex_no_der(const SM2_KEY *key, int flags, const uint8_t dgst[32], uint8_t *sig, size_t *siglen);
int sm2_sign_no_der(const SM2_KEY *key, const uint8_t dgst[32], uint8_t *sig, size_t *siglen);
int sm2_verify(const SM2_KEY *key, const uint8_t dgst[32], const uint8_t *sig, size_t siglen);
int sm2_verify_no_der(const SM2_KEY *key, const uint8_t dgst[32], const uint8_t *sig, size_t siglen);
...
int sm2_sign_finish_no_der(SM2_SIGN_CTX *ctx, uint8_t *sig, size_t *siglen);
...
int sm2_verify_finish_no_der(SM2_SIGN_CTX *ctx, const uint8_t *sig, size_t siglen);
