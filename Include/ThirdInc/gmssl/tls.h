...
int tls_session_ticket_ext_to_bytes(uint8_t **out, size_t *outlen);
int tls_process_client_session_tkt(const uint8_t *ext_data, size_t ext_datalen,
	uint8_t **out, size_t *outlen);
int tls_process_client_then_mac(const uint8_t *ext_data, size_t ext_datalen,
	uint8_t **out, size_t *outlen);
int tls_process_client_master_sec(const uint8_t *ext_data, size_t ext_datalen,
	uint8_t **out, size_t *outlen);
